...
public class P0503_CPListCtrl {
    ...
    public String list(Model model,
            ...
            P0503_CPListDTO searchFilter) {

        System.out.println("생산 실적 조회");
        System.out.println("생산 실적 조회 조건: " + searchFilter);
        ...
        // ===================== 4) 목록 조회 =====================
        List<P0503_CPListDTO> list = service.list(page, pagePerRows, searchFilter);
